...
<head>
    ...
    <title>Gestión de Bloqueos</title>
    ...
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-6xl mx-auto">
            <div class="flex justify-between items-center mb-8">
                <h1 class="text-3xl font-bold">Gestión de Bloqueos</h1>
                <a href="/bloqueos" class="px-6 py-3 bg-success text-white rounded-lg hover:bg-green-600 transition-colors font-medium focus:ring-2 focus:ring-success">
            ...
            <div class="bg-darker rounded-lg p-6 shadow-[0_2px_8px_rgba(0,0,0,0.3)]">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <span class="text-light-gray">
                        <?php echo count($data['bloqueos'] ?? []); ?> bloqueos encontrados
                    </span>
                </div>

                <?php if (!empty($data['bloqueos'])): ?>
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <?php foreach ($data['bloqueos'] as $bloqueo): ?>
                            <div class="bg-gray rounded-lg p-6 shadow-[0_2px_8px_rgba(0,0,0,0.3)] hover:shadow-[0_4px_12px_rgba(0,0,0,0.4)] transition-all duration-300">
                                ...
                                <?php if (!empty($bloqueo['imagen'])): ?>
                                    <div class="mb-4 text-center">
                                        <img src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 80 80'%3E%3Crect width='80' height='80' fill='%23374151'/%3E%3C/svg%3E" 
                                             data-src="../imgs/uploads/bloqueos/<?php echo htmlspecialchars($bloqueo['imagen']); ?>" 
                                             alt="<?php echo htmlspecialchars($bloqueo['nombre']); ?>"
                                ...
                                <div class="mb-4">
                                    <h3 class="text-lg font-bold mb-2 text-success">
                                        🛡️ <?php echo htmlspecialchars($bloqueo['nombre']); ?>
                                    </h3>
                                    <div class="text-sm text-light-gray mb-3">
                                        ID: #<?php echo htmlspecialchars($bloqueo['id_supertecnica']); ?>
                                    </div>
                                </div>
                                ...
                                <div class="space-y-2 text-sm mb-4">
                                    <div class="flex justify-between">
                                        ...
                                        <span class="font-medium">
                                            ...
                                            echo ($iconosElemento[$bloqueo['elemento']] ?? '') . ' ' . ucfirst(htmlspecialchars($bloqueo['elemento']));
                                            ?>
                                        </span>
                                    </div>
                                    
                                    <?php if (!empty($bloqueo['subtipo']) && $bloqueo['subtipo'] !== 'normal'): ?>
                                        <div class="flex justify-between">
                                            <span class="text-light-gray">Subtipo:</span>
                                            <span class="font-medium text-warning">
                                                🛡️ <?php echo htmlspecialchars($bloqueo['subtipo']); ?>
                                            </span>
                                        </div>
                                    <?php endif; ?>
                                    ...
                                    <div class="flex justify-between">
                                        ...
                                        <span class="font-medium text-success">
                                            ⚡ <?php echo htmlspecialchars($bloqueo['potencia']); ?>
                                        </span>
                                    </div>
                                    ...
                                    <div class="flex justify-between">
                                        ...
                                        <span class="font-medium text-warning">
                                            💰 <?php echo htmlspecialchars($bloqueo['costo']); ?> PT
                                        </span>
                                    </div>
                                    ...
                                    <div class="flex justify-between">
                                        ...
                                        <span class="font-medium text-info">
                                            📊 <?php echo htmlspecialchars($bloqueo['dificultad']); ?>
                                        </span>
                                    </div>
                                    ...
                                    <div class="flex justify-between">
                                        ...
                                        <span class="font-medium text-info">
                                            ⚔ <?php echo htmlspecialchars($bloqueo['eg_damage']); ?>
                                        </span>
                                    </div>
                                    ...
                                    <div class="flex justify-between">
                                        ...
                                        <span class="font-medium text-info">
                                            <?php 
                                            $nJugadores = (int)$bloqueo['n_jugadores'];
                                            switch($nJugadores) {
                                                case 1:
                                                    echo '👤 1 Jugador';
                                                    break;
                                ...
                                <div class="flex gap-2 mt-4">
                                    <a href="/bloqueosEdit/<?php echo urlencode($bloqueo['id_supertecnica']); ?>" 
                                    ...
                                    <button onclick="confirmarEliminacion('bloqueo', <?php echo (int) $bloqueo['id_supertecnica']; ?>, '<?php echo htmlspecialchars($bloqueo['nombre'], ENT_QUOTES); ?>')"
